	    ...
	    std::ptrdiff_t size_left = std::distance(first, new_first);
            ...
            */
            ...
            return dataflow(
                ...
                r.call2(execution::processing_units_count(p, numcores1), non_seq(), first, new_first),
                r.call2(execution::processing_units_count(p, numcores2), non_seq(), new_first, last));
